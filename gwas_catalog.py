    ...
    for variant in variants:
        ...
        if response.status_code == 200:
            ...
            for association in associations:
                ...
                summary.append([variant, locus, risk_A, risk_AF, beta, stderr, pvalue, study_trait, pubmedId])
    # Create the summary as dataframe
    df = pd.DataFrame(summary, columns = ["variant", "Locus", "Risk_A", "Risk_AF", "Beta", "Stderr", "Pvalue", "Trait", "Pubmed_ID"])
    return df
#----------------#
...
df.to_csv(r'~/projects/variant_interrogation/summary_results_all.csv', index = False, header = True, sep = "\t")
